	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("<leader>cc", require("telescope.builtin").lsp_definitions, "[C]ode Variable [C]reation")

				-- Find references for the word under your cursor.
				map("<leader>cu", require("telescope.builtin").lsp_references, "[G]oto [U]sages")
		...
		-- Strudel LSP is manually installed, not via Mason
		-- Configuration is handled separately after mason-lspconfig
		...
		ensure_installed = vim.tbl_filter(function(name)
			return name ~= "strudel_lsp" and name ~= "arduino_language_server"
